...
slug realSlug urlSensitiv author keyword{__typename ${config.LANGUAGES.join(' ')}} description{__typename ${config.LANGUAGES.join(' ')}} template script resources resolvedData style html meta subscriptions publicEdit ssrStyle uniqueStyle alwaysLoadAssets parseResolvedData}}`
