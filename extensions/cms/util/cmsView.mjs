...
const CMS_PAGE_QUERY_BASE =`query cmsPage($slug:String!,$query:String,$meta:String,$props:String,$nosession:String,$editmode:Boolean,$inEditor:Boolean,$dynamic:Boolean,$_version:String){
...
export const getCmsPageQuery = (props, state)=>{
