...
export const DEFAULT_TEMPLATE_MINIMAL = `{
  "$inlineEditor": {
    "allowDrop": true,
    "elementKey": "custom"
  },
...
export const DEFAULT_STYLE_ENVIRONMENT = `//!#Environment
...
export const DEFAULT_STYLE_EDITOR = `//!#Grid
...
export const DEFAULT_STYLE = `${DEFAULT_STYLE_ENVIRONMENT}
//!#General
#page{
