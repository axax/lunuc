...
const LinkedInProfileContainer = (props) => <Async {...props} load={import(/* webpackChunkName: "social" */ './containers/LinkedInProfileContainer')} />
const Button = (props) => <Async {...props} expose="Button" load={import(/* webpackChunkName: "admin" */ '../../gensrc/ui/admin')} />
const SimpleToolbar = (props) => <Async {...props} expose="SimpleToolbar" load={import(/* webpackChunkName: "admin" */ '../../gensrc/ui/admin')} />
