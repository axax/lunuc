export default `
    ...
    type Query {
    	...
    	sendNewsletter(mailing: ID!, subject: LocalizedStringInput!, template: String!, list:[ID], batchSize: Float, host: String, text: LocalizedStringInput, html: LocalizedStringInput): NewsletterSendStatus
    }
