export default `
    ...
    type Query {
    	...
    	sendNewsletter(mailing: ID!, subject: LocalizedStringInput!, template: String, list:[ID], users:[ID], unsubscribeHeader: Boolean, batchSize: Float, host: String, text: LocalizedStringInput, html: LocalizedStringInput): NewsletterSendStatus
    }
