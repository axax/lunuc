...
import CodeMirrorWrapper from './codemirror5/CodeMirrorWrapper'
import CodeMirror from 'codemirror'
import './codemirror5/javascript'
import './codemirror5/formatting'
import './codemirror5/keywords'
import './codemirror5/search'
...
import './codemirror5/style.css'
import './codemirror5/dialog.css'
import './codemirror5/hint.css'
...
class CodeEditor extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        if(update && !nextState.error && nextState.scrollPosition){
            setTimeout(()=>{
