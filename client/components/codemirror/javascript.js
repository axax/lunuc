...
(function (mod) {
    ...
    CodeMirror.defineMode("customJs", function (config, parserConfig) {
        ...
        var keywords = function () {
            ...
            /* custom part */
            const customKeywords = ['fetchMore', 'addMetaTag', 'setStyle', 'clientQuery', 'on', 'Util', 'scope', 'history', 'refresh', 'forceUpdate', 'getLocal', 'setLocal', 'parent', 'root', 'getComponent', 'getKeyValueFromLS', 'setKeyValue']
