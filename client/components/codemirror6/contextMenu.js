                    ...
                    if (jsonData.fixed) {
                        editorView.dispatch({
                            changes: {
                                ...
                                insert: JSON.stringify(jsonData.json, null, 2)
                            }
                        })
                    }
                }
        ...
        if (fileSplit) {
            contextMenuItems.push({
                ...
                name: _t('CodeEditor.newFileSplit'), onClick: () => {
                    setEditData({
                        fileSplit: true,
                        fields: {name: {fullWidth: true, label: 'Name', required: true}},
                        lineInfo
                    })
                }
            })
            ...
            contextMenuItems.push({
                ...
                name: (showFileSplit ? _t('CodeEditor.hideFileSplit') : _t('CodeEditor.showFileSplit')),
                onClick: () => {
