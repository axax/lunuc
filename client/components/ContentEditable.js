...
const reservedJsCustomKeywords = ['clientQuery', 'on', 'Util', 'scope', 'history', 'refresh','forceUpdate', 'getLocal', 'setLocal', 'parent', 'root', 'getComponent', 'getKeyValueFromLS', 'setKeyValue']
