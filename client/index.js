...
if (!window.LUNUC_PREPARSED) {
    ...
    if (noneObject) {
        ...
        DomUtil.addScript('https://polyfill.io/v3/polyfill.min.js?features=Intl%2CIntl.DateTimeFormat%2Cfetch%2CURL%2Ces6%2CObject.values%2CObject.entries%2CPromise.prototype.finally%2CAbortController%2CEvent'+(ua?'&ua='+ua:''), {
            async: true,
            onload
        })
    }
