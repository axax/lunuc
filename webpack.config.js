...
fs.readdir(extensionFolder, (err, files) => {
    ...
    var clientContent = '/* this file was generated by webpack.config.js */\r\n\r\n'
    var serverContent = clientContent
    ...
    fs.writeFile("./src/extensions.js", clientContent, function(err) {
        if(err) {
            return console.log(err)
        }
    })
    fs.writeFile("./api/extensions.js", serverContent, function(err) {
        if(err) {
            return console.log(err)
        }
    })
