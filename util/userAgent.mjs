...
export const DEFAULT_BOT_WITH_NO_JS_SUPPORT_REGEX = /YandexBot|Iframely|SeekportBot|DuckDuckBot|localsearch|facebookexternalhit|LinkedInBot|Xing|WhatsApp|TelegramBot|\(compatible; ITools;/i
