...
export const CAPABILITY_MANAGE_SUBSCRIBERS = 'manage_subscribers'
...
export const getAllCapabilites = () =>{
    ...
    if( !_allCapabilities ){
        _allCapabilities = [CAPABILITY_VIEW_APP, CAPABILITY_ACCESS_ADMIN_PAGE, CAPABILITY_MANAGE_TYPES, CAPABILITY_MANAGE_KEYVALUES, CAPABILITY_MANAGE_OTHER_USERS, CAPABILITY_MANAGE_COLLECTION, CAPABILITY_MANAGE_USER_ROLE, CAPABILITY_MANAGE_BACKUPS, CAPABILITY_RUN_COMMAND, CAPABILITY_RUN_SCRIPT]
