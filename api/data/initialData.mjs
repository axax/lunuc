...
import {
    ...
    CAPABILITY_BULK_EDIT, CAPABILITY_EXTRA_OPTIONS
    ...
    const userRoles = [
        {
            ...
            capabilities: [CAPABILITY_VIEW_APP, CAPABILITY_MANAGE_USER_ROLE, CAPABILITY_MANAGE_USER_GROUP,
                ...
                CAPABILITY_MANAGE_KEYVALUES, CAPABILITY_MANAGE_COLLECTION, CAPABILITY_BULK_EDIT, CAPABILITY_MANAGE_OTHER_USERS,
                CAPABILITY_MANAGE_BACKUPS, CAPABILITY_RUN_COMMAND, CAPABILITY_RUN_SCRIPT, CAPABILITY_EXTRA_OPTIONS]
        },
        {
            name: 'editor',
            capabilities: [CAPABILITY_VIEW_APP, CAPABILITY_ACCESS_ADMIN_PAGE, CAPABILITY_MANAGE_COLLECTION, CAPABILITY_MANAGE_SAME_GROUP]
        },
        {
            name: 'author',
            capabilities: [CAPABILITY_VIEW_APP, CAPABILITY_ACCESS_ADMIN_PAGE, CAPABILITY_MANAGE_SAME_GROUP]
        },
        {
            name: 'contributor',
