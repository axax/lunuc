...
export const createUserRoles = async (db) => {
    ...
    const userRoles = [
        ...
        },
        {
            ...
            name: 'editor',
            capabilities: [CAPABILITY_BULK_EDIT, CAPABILITY_VIEW_APP, CAPABILITY_ACCESS_ADMIN_PAGE, CAPABILITY_MANAGE_COLLECTION, CAPABILITY_MANAGE_SAME_GROUP, CAPABILITY_SET_INITIAL_PASSWORD, CAPABILITY_EXTRA_OPTIONS, CAPABILITY_MANAGE_USER_GROUP]
        },
        {
            prettyName: {de: 'Author', en: 'Author'},
            name: 'author',
            capabilities: [CAPABILITY_BULK_EDIT, CAPABILITY_VIEW_APP, CAPABILITY_ACCESS_ADMIN_PAGE, CAPABILITY_MANAGE_SAME_GROUP, CAPABILITY_SET_INITIAL_PASSWORD, CAPABILITY_MANAGE_USER_GROUP]
        },
        {
