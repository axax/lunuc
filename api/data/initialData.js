    ...
    const userRoles = [
        {
            ...
            capabilities: [CAPABILITY_VIEW_APP, CAPABILITY_MANAGE_USER_ROLE, CAPABILITY_MANAGE_USER_GROUP,
                CAPABILITY_ACCESS_ADMIN_PAGE, CAPABILITY_MANAGE_TYPES, CAPABILITY_MANAGE_SUBSCRIBERS,
        ...
        {
            name: 'editor',
            capabilities: [CAPABILITY_VIEW_APP, CAPABILITY_ACCESS_ADMIN_PAGE, CAPABILITY_MANAGE_TYPES, CAPABILITY_MANAGE_SUBSCRIBERS]
        },
        {
            name: 'author',
            capabilities: [CAPABILITY_VIEW_APP, CAPABILITY_ACCESS_ADMIN_PAGE, CAPABILITY_MANAGE_SUBSCRIBERS]
        },
        {
            name: 'contributor',
