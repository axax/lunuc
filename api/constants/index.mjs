...
export const AUTH_EXPIRES_IN = process.env.LUNUC_AUTH_EXPIRES_IN || '15d'
export const AUTH_EXPIRES_IN_COOKIE = process.env.LUNUC_AUTH_EXPIRES_IN_COOKIE || (1000 * 60 * 60 * 24 * 15)
