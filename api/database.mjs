...
export const MONGO_URL = (process.env.LUNUC_MONGO_URL || process.env.MONGO_URL || 'mongodb://127.0.0.1:27018/lunuc')
export const BACKUP_MONGO_URL = (process.env.LUNUC_BACKUP_MONGO_URL || 'mongodb://127.0.0.1:27018/lunuc_backup') // 'mongodb://localhost:27018/lunuc'
